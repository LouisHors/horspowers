...
const cases = [
  ...
  ['routes a standalone request to write a failing test first', '先写失败测试', null, 'tdd', 'horspowers:test-driven-development'],
  ['routes a standalone request to add a reproducing test first', '先补一个复现测试', null, 'tdd', 'horspowers:test-driven-development'],
  ['routes a standalone request to automate acceptance behavior', '把验收行为写成自动化测试', null, 'tdd', 'horspowers:test-driven-development'],
  ['routes a standalone request to lock a bug with a failing case', '先用一个 failing case 把问题固定住', null, 'tdd', 'horspowers:test-driven-development'],
