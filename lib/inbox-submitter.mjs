...
function safeMetadataText(value, { projectId = false } = {}) {
  if (typeof value !== 'string') return false;
  return inspectSubmissionMetadataIdentifier(value, { projectId })?.ok === true;
}
...
function validMetadata(value) {
  ...
  if (!safeMetadataText(value.project_id, { projectId: true }) || !safeMetadataText(value.logical_id)) {
    return false;
  }
